...
local RENDERER_BASE = BASE .. "dist/ui/v13-desktop/"
...
if not fn then
    error(
        "[SERENITY HUB] Failed to compile V13 desktop renderer: "
            .. tostring(err),
        0
    )
end
...
Library.Version = "13.5-desktop-v3-icons"
